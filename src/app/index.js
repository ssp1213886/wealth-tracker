...
/* === Covered Call === */
var optionTrades=[];
function loadOpt(){try{var raw=JSON.parse(localStorage.getItem(KEYS.options)||"[]"),opts=normalizeOptions(raw);if(stableStr(raw)!==stableStr(opts))localStorage.setItem(KEYS.options,JSON.stringify(opts));return opts}catch(e){return[]}}
